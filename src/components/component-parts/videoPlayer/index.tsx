...
export default function VideoItem({
  ...
  return (
    <TouchableWithoutFeedback onPress={() => onMuteHandle(mute)}>
      <View
        style={[
          styles.container,
        ...
        {type == 'image' && (
          <ImageBackground
            ...
            source={{uri: avatarUri}}></ImageBackground>
        )}
          ...
          <View style={styles.bottomLeftSection}>
            ...
            <View style={styles.musicNameContainer}>
              ...
              <View>
                ...
                <Text style={styles.caption}>User title</Text>
              </View>
            </View>
            <View>
              <Text style={styles.channelName}>
                {'User name'}
                <Text style={styles.caption}> {'user caption here'}</Text>
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.verticalBar}>
          <View style={[styles.verticalBarItem, styles.avatarContainer]}>
            ...
            <View style={styles.followButton}>
              <IconIon
                ...
                onPress={() => alert('for follow the user')}
              />
            </View>
          </View>
          <View style={styles.verticalBarItem}>
            ...
            />
            <Text style={[st.tx14_menu, st.txAlignC, {color: colors.skyblue}]}>
              {likes}
            </Text>
          </View>
          <View style={styles.verticalBarItem}>
        ...
        {type == 'video' && (
          <View style={st.center}>
            <IconIon
              name={!mute ? 'volume-medium-outline' : 'md-volume-mute-outline'}
              size={25}
              color={'#fff'}
            />
          </View>
